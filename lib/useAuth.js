...
// _app prüft hiermit, ob ein Bestätigungs-/Recovery-Link fehlgeschlagen ist,
// und leitet dann zu /login um; die Login-Seite konsumiert den Fehler und
  ...
  useEffect(() => {
    ...
    import('@netlify/identity').then(async ({ getUser, hydrateSession, onAuthChange, handleAuthCallback }) => {
      try {
        ...
        // ungültiger oder abgelaufener Bestätigungs-/Recovery-Link
        callbackFailed = true;
      }
